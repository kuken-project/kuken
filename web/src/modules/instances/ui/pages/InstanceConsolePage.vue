...
const searchResults = computed(() => {
  ...
  return filteredFrames.value.filter(f =>
...
const setupListeners = () => {
  ...
  unsubscribeFrames = websocketService.listen(
      WebSocketOpCodes.InstanceLogsRequestFrame,
      addFrame
  )

  unsubscribeEnd = websocketService.listen(
    ...
    <div class="console-toolbar">
      ...
      <div class="toolbar-right">
        <div class="connection-status" :class="{
          ...
          <template v-if="logsEnded">
            Logs Ended
          </template>
          <template v-else-if="fetechedWhileStopped">
            Server closed
          </template>
          <template v-else>
